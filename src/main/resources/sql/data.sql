...
INSERT INTO categorias_despesas(categoria) VALUES('despesasS DIVERSAS');
INSERT INTO categorias_despesas(categoria) VALUES('FOLHA DE PAGAMENTO');




INSERT INTO despesas(nome,descricao,categoria_id,quitado,tipo) VALUES('PAGAMENTO FOLHA SALARIAL ABRIL DE 2025','PAGAMENTO FOLHA SALARIAL ABRIL DE 2025',1,false,'DESPESA_AVULSA');
...
INSERT INTO despesas(nome,descricao,categoria_id,quitado,tipo) VALUES('PEÇAS VEICULOS UTH7645','COMPRA DE FILTRO DE OLEO \n COMPRA DE OLEO',3,false,'DESPESA_AVULSA');
...
INSERT INTO despesas(nome,descricao,categoria_id,quitado,tipo,valor_total) VALUES('LIGHT','PAGAMENTO MENSAL DA LUZ',3,false,'DESPESA_RECORRENTE',200.00);
INSERT INTO despesas_recorrentes(id,dia_pagamento,periocidade,forma_pagamento_padrao,ativo) VALUES(3,10,'MENSAL',1,true);

INSERT INTO despesas(nome,descricao,categoria_id,quitado,tipo,valor_total) VALUES('CEDAE','PAGAMENTO MENSAL DA AGUA',3,false,'DESPESA_RECORRENTE',100.00);
...
INSERT INTO despesas(nome,descricao,categoria_id,quitado,tipo,valor_total) VALUES('INTERNET','PAGAMENTO MENSAL DA INTERNET',3,false,'DESPESA_RECORRENTE',95.00);
...
INSERT INTO despesas(nome,descricao,categoria_id,quitado,tipo,valor_total) VALUES('PAGAMENTO COMBUSTIVEL','COMBUSTIVEL',3,false,'DESPESA_RECORRENTE',950.00);
